...
where it was developed in-tree as `team_layer/` + `nth_team_layer/`.
...
#### PR 8: `nth_team_layer/` — Pluggable facade (2096 lines)
...
- Extracted to this standalone repo to enable `pip install nth-team-layer`
